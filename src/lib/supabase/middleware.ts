 ...
 * cookie-based auth flow: without this, sessions silently expire because
 * nothing ever calls getUser() to trigger a token refresh outside of a page
 * load that happens to need it.
 */
